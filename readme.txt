...
<form>
          ...
          <input type="name" name="job-title" placeholder="Job Title">
          <input type="number" name="how-many-people" placeholder="How many people in your organization might use Ally RIght?">
